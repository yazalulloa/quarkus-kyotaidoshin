...
public class EnvParams {
  ...
  public String addEnvInfo(String msg) {
    return addEnvInfo(msg, true, false);
  }

  public String addEnvInfo(String msg, boolean addTimeUp, boolean addSystemInfo) {
    ...
    if (addSystemInfo) {
      SystemUtil.systemInfo().forEach(str -> builder.append("\n").append(str));
    }
