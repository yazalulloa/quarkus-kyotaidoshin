...
import com.yaz.kyotaidoshin.util.NativeRegistration;
...
public class PrintNativeRegistration {
  ...
  public static void main(String[] args) throws IOException {
    ...
    final var wsTursoClasses = classesFromPackage("com.yaz.kyotaidoshin.persistence.repository.turso.client.ws");
    final var modelClasses = classesFromPackage("com.yaz.kyotaidoshin.persistence.model");
